...
},{begin:s+":",end:":",returnBegin:!0,returnEnd:!0,relevance:0}])}}}());hljs.registerLanguage("protobuf",function(){"use strict";return function(e){
return{name:"Protocol Buffers",keywords:{
...
keywords:"rpc returns"},{begin:/^\s*[A-Z_]+/,end:/\s*=/,excludeEnd:!0}]}}}());hljs.registerLanguage("elm",function(){"use strict";return function(e){var n={
...
}());hljs.registerLanguage("clojure",function(){"use strict";return function(e){
...
className:"comment",begin:"\\^"+n},u=e.COMMENT("\\^\\{","\\}"),p={
className:"symbol",begin:"[:]{1,2}"+n},f={begin:"\\(",end:"\\)"},h={
endsWithParent:!0,relevance:0},y={keywords:a,className:"name",begin:n,starts:h
},g=[f,i,m,u,c,p,l,o,d,s],b={beginKeywords:r,lexemes:n,
...
h.contains=g,l.contains=g,u.contains=[l],{name:"Clojure",aliases:["clj"],
illegal:/\S/,contains:[f,i,m,u,c,p,l,o,d]}}}());hljs.registerLanguage("clojure-repl",function(){"use strict";return function(e){
return{name:"Clojure REPL",contains:[{className:"meta",
begin:/^([\w.-]+|\s*#_)?=>/,starts:{end:/$/,subLanguage:"clojure"}}]}}}());hljs.registerLanguage("bash",function(){"use strict";return function(e){
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("latex",function(){"use strict";return function(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("scala",function(){"use strict";return function(e){var n={
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}}());hljs.registerLanguage("dockerfile",function(){"use strict";return function(e){
return{name:"Dockerfile",aliases:["docker"],case_insensitive:!0,
keywords:"from maintainer expose env arg user onbuild stopsignal",
contains:[e.HASH_COMMENT_MODE,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE,{
beginKeywords:"run cmd entrypoint volume add copy workdir label healthcheck shell",
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"}}}());hljs.registerLanguage("lua",function(){"use strict";return function(e){
...
begin:/\b(print|exec)\(/}]}}}());hljs.registerLanguage("lisp",function(){"use strict";return function(e){
...
contains:[b,e.SHEBANG(),s,g,l,o,u,m,c]}}}());hljs.registerLanguage("php",function(){"use strict";return function(e){var r={
...
;return n.name="C",n.aliases=["c","h"],n}}());hljs.registerLanguage("elixir",function(){"use strict";return function(e){
var n="[a-zA-Z_][a-zA-Z0-9_.]*(\\!|\\?)?",i={$pattern:n,
...
name:"Elixir",keywords:i,contains:t}}}());hljs.registerLanguage("scheme",function(){"use strict";return function(e){
var t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n={$pattern:t,
...
contains:[e.SHEBANG(),a,i,l,u,d].concat(c)}}}());hljs.registerLanguage("processing",function(){"use strict";return function(e){
return{name:"Processing",keywords:{
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("erlang",function(){"use strict";return function(e){
...
},contains:[E]},c,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}}());hljs.registerLanguage("http",function(){"use strict";return function(e){
...
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}}}());hljs.registerLanguage("matlab",function(){"use strict";return function(e){
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*\\%\\{\\s*$","^\\s*\\%\\}\\s*$"),e.COMMENT("\\%","$")]}}}());hljs.registerLanguage("apache",function(){"use strict";return function(e){
...
}],illegal:/\S/}}}());hljs.registerLanguage("hy",function(){"use strict";return function(e){
...
},n={begin:t,relevance:0},r={className:"number",begin:"[-+]?\\d+(\\.\\d+)?",
...
return E.split("|")[0]})).join("|");return{name:"PostgreSQL",
aliases:["postgres","postgresql"],case_insensitive:!0,keywords:{
